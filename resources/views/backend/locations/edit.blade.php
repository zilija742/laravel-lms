...
@section('content')
    {{ html()->modelForm($location, 'PATCH', route('admin.locations.update', $location->id))->class('form-horizontal')->acceptsFiles()->open() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->label(html()->checkbox('')->name('active')
                                        ->checked(($location->active == 1) ? true : false)->class('switch-input')->value(($location->active == 1) ? 1 : 0)
