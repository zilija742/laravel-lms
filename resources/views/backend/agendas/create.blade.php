...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-10 form-group">
                    {!! Form::label('user_id',trans('labels.backend.agendas.fields.teacher'), ['class' => 'control-label']) !!}
                    {!! Form::select('user_id', $teachers, old('user_id'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required' => true]) !!}
                </div>
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
